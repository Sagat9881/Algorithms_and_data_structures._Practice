...
public class MyArrayList<T> implements List<T> {
    int size;                    // Поле "Size" явно хранит в себе количество элементов в ArrayList'е
    private final T[] array;           // Контейнер для элементов. Массив с параметризированными объектами (Дженериками);
